...
public class HoursValidCoCoTest extends AbstractCoCoTest {
  ...
  public void testHours() throws IOException {
    checkInvalid(basedir+ "invalid/InvalidHours.tc");
  }
  ...
  private void checkInvalid(String s) throws IOException {
    ...
    assertEquals(HoursValidCoCo.message,Log.getFindings().get(0).getMsg());
  }
