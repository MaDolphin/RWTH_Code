...
import de.monticore.ast.ASTCNode;
 ...
 public  ASTBreak build ()  {
      /* generated by template _ast.builder.BuildMethod*/
        ...
        if (!isValid()) {
            if (start == null) {
                Log.error("0xA7222 start of type appointmentsflexibilized._ast.ASTStart must not be null");
            }
            if (end == null) {
                Log.error("0xA7222 end of type appointmentsflexibilized._ast.ASTEnd must not be null");
            }
...
return this.end;
    ...
    /* generated by template core.Method*/
 public  ASTBreakBuilder setStart (appointmentsflexibilized._ast.ASTStart start)  {
    ...
    /* generated by template core.Method*/
 public  ASTBreakBuilder setEnd (appointmentsflexibilized._ast.ASTEnd end)  {
      /* generated by template _ast.builder.Set*/
