...
grammar AppointmentsFlexibilizedAntlr;
@parser::header {
...
appointment_eof returns [appointmentsflexibilized._ast.ASTAppointment ret = null] :
  tmp = appointment {$ret = $tmp.ret;} EOF ;


  appointment returns [appointmentsflexibilized._ast.ASTAppointment ret = null]
@init{// ret is normally returned, a is used to be compatible with rule using the return construct
...
LCURLY// End of 'ASTTerminal'
  ...
  ( tmp1=i{addToIteratedAttributeIfNotNull(_aNode.getIList(), _localctx.tmp1.ret);}) * 
...
start_eof returns [appointmentsflexibilized._ast.ASTStart ret = null] :
  tmp = start {$ret = $tmp.ret;} EOF ;


  start returns [appointmentsflexibilized._ast.ASTStart ret = null]
@init{// ret is normally returned, a is used to be compatible with rule using the return construct
...
end_eof returns [appointmentsflexibilized._ast.ASTEnd ret = null] :
  tmp = end {$ret = $tmp.ret;} EOF ;


  end returns [appointmentsflexibilized._ast.ASTEnd ret = null]
@init{// ret is normally returned, a is used to be compatible with rule using the return construct
...
date_eof returns [appointmentsflexibilized._ast.ASTDate ret = null] :
  tmp = date {$ret = $tmp.ret;} EOF ;


  date returns [appointmentsflexibilized._ast.ASTDate ret = null]
@init{// ret is normally returned, a is used to be compatible with rule using the return construct
...
time_eof returns [appointmentsflexibilized._ast.ASTTime ret = null] :
  tmp = time {$ret = $tmp.ret;} EOF ;


  time returns [appointmentsflexibilized._ast.ASTTime ret = null]
@init{// ret is normally returned, a is used to be compatible with rule using the return construct
...
r__break_eof returns [appointmentsflexibilized._ast.ASTBreak ret = null] :
  tmp = r__break {$ret = $tmp.ret;} EOF ;


  r__break returns [appointmentsflexibilized._ast.ASTBreak ret = null]
@init{// ret is normally returned, a is used to be compatible with rule using the return construct
...
RCURLY// End of 'ASTTerminal'
 ...
 // Start of 'ASTClassProd Participants'


participants_eof returns [appointmentsflexibilized._ast.ASTParticipants ret = null] :
  tmp = participants {$ret = $tmp.ret;} EOF ;


  participants returns [appointmentsflexibilized._ast.ASTParticipants ret = null]
@init{// ret is normally returned, a is used to be compatible with rule using the return construct
...
', '// End of 'ASTTerminal'
  ...
  (tmp1=String{ addToIteratedAttributeIfNotNull(_aNode.getStringList(), convertString($tmp1));}
 ...
 // Start of 'ASTClassProd Frequency'


frequency_eof returns [appointmentsflexibilized._ast.ASTFrequency ret = null] :
  tmp = frequency {$ret = $tmp.ret;} EOF ;


  frequency returns [appointmentsflexibilized._ast.ASTFrequency ret = null]
@init{// ret is normally returned, a is used to be compatible with rule using the return construct
...
i_eof returns [appointmentsflexibilized._ast.ASTI ret = null] :
  tmp = i {$ret = $tmp.ret;} EOF ;


  i
   returns [appointmentsflexibilized._ast.ASTI ret]
  : 
