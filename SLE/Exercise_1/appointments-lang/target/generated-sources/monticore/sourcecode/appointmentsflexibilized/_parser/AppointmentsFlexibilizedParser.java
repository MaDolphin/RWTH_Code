...
public class AppointmentsFlexibilizedParser extends MCConcreteParser {

  protected AppointmentsFlexibilizedAntlrParser create(String filename) throws IOException {
    AppointmentsFlexibilizedAntlrLexer lexer = new AppointmentsFlexibilizedAntlrLexer(new  ANTLRFileStream(filename, StandardCharsets.UTF_8.name()));
    CommonTokenStream tokens = new CommonTokenStream(lexer);
    AppointmentsFlexibilizedAntlrParser parser = new AppointmentsFlexibilizedAntlrParser(tokens);
  ...
  protected AppointmentsFlexibilizedAntlrParser create(Reader reader) throws IOException {
    AppointmentsFlexibilizedAntlrLexer lexer = new AppointmentsFlexibilizedAntlrLexer(new ANTLRInputStream(reader));
    CommonTokenStream tokens = new CommonTokenStream(lexer);
    AppointmentsFlexibilizedAntlrParser parser = new AppointmentsFlexibilizedAntlrParser(tokens);
    lexer.setMCParser(parser);  
    lexer.removeErrorListeners();
   ...
   */
  @Override
  public Optional<appointmentsflexibilized._ast.ASTAppointment> parse(String fileName) throws IOException {
   ...
   */
  @Override
  public Optional<appointmentsflexibilized._ast.ASTAppointment> parse(Reader reader) throws IOException {
    return parseAppointment(reader);
  }
  
  public Optional<appointmentsflexibilized._ast.ASTAppointment> parse_String(String str) throws IOException {
  ...
  public Optional<de.monticore.literals.mcliteralsbasis._ast.ASTLiteral> parseLiteral(String filename) throws IOException {   
    AppointmentsFlexibilizedAntlrParser parser = create(filename);    
  ...
  public  Optional<de.monticore.literals.mcliteralsbasis._ast.ASTLiteral> parseLiteral(Reader reader) throws IOException {
 	AppointmentsFlexibilizedAntlrParser parser = create(reader);
	de.monticore.literals.mcliteralsbasis._ast.ASTLiteral ast;
    ast = parser.literal_eof().ret;
    if (parser.hasErrors()) {
      setError(true);
   ...
   * @throws IOException if something went wrong parsing the file
   */
  public Optional<appointmentsflexibilized._ast.ASTAppointment> parseAppointment(String filename) throws IOException {   
    AppointmentsFlexibilizedAntlrParser parser = create(filename);    
	appointmentsflexibilized._ast.ASTAppointment ast;
    ast = parser.appointment_eof().ret;
    if (parser.hasErrors()) {
      setError(true);
      return Optional.<appointmentsflexibilized._ast.ASTAppointment> empty();
    }
    return Optional.ofNullable(ast);
  }
   ...
   * @throws IOException if something went wrong parsing the content of the reader
   * */
  public  Optional<appointmentsflexibilized._ast.ASTAppointment> parseAppointment(Reader reader) throws IOException {
 	AppointmentsFlexibilizedAntlrParser parser = create(reader);
	appointmentsflexibilized._ast.ASTAppointment ast;
    ast = parser.appointment_eof().ret;
    if (parser.hasErrors()) {
   ...
   * @throws IOException if something went wrong parsing the string
   * */
  public  Optional<appointmentsflexibilized._ast.ASTAppointment> parse_StringAppointment(String str) throws IOException {
   ...
   * @throws IOException if something went wrong parsing the file
   */
  public Optional<appointmentsflexibilized._ast.ASTStart> parseStart(String filename) throws IOException {   
    AppointmentsFlexibilizedAntlrParser parser = create(filename);    
	appointmentsflexibilized._ast.ASTStart ast;
    ast = parser.start_eof().ret;
    if (parser.hasErrors()) {
      setError(true);
      return Optional.<appointmentsflexibilized._ast.ASTStart> empty();
    }
    return Optional.ofNullable(ast);
  }
   ...
   * @throws IOException if something went wrong parsing the content of the reader
   * */
  public  Optional<appointmentsflexibilized._ast.ASTStart> parseStart(Reader reader) throws IOException {
 	AppointmentsFlexibilizedAntlrParser parser = create(reader);
	appointmentsflexibilized._ast.ASTStart ast;
    ast = parser.start_eof().ret;
    if (parser.hasErrors()) {
   ...
   * @throws IOException if something went wrong parsing the string
   * */
  public  Optional<appointmentsflexibilized._ast.ASTStart> parse_StringStart(String str) throws IOException {
   ...
   * @throws IOException if something went wrong parsing the file
   */
  public Optional<appointmentsflexibilized._ast.ASTEnd> parseEnd(String filename) throws IOException {   
    AppointmentsFlexibilizedAntlrParser parser = create(filename);    
	appointmentsflexibilized._ast.ASTEnd ast;
    ast = parser.end_eof().ret;
    if (parser.hasErrors()) {
      setError(true);
      return Optional.<appointmentsflexibilized._ast.ASTEnd> empty();
    }
    return Optional.ofNullable(ast);
  }
   ...
   * @throws IOException if something went wrong parsing the content of the reader
   * */
  public  Optional<appointmentsflexibilized._ast.ASTEnd> parseEnd(Reader reader) throws IOException {
 	AppointmentsFlexibilizedAntlrParser parser = create(reader);
	appointmentsflexibilized._ast.ASTEnd ast;
    ast = parser.end_eof().ret;
    if (parser.hasErrors()) {
   ...
   * @throws IOException if something went wrong parsing the string
   * */
  public  Optional<appointmentsflexibilized._ast.ASTEnd> parse_StringEnd(String str) throws IOException {
   ...
   * @throws IOException if something went wrong parsing the file
   */
  public Optional<appointmentsflexibilized._ast.ASTDate> parseDate(String filename) throws IOException {   
    AppointmentsFlexibilizedAntlrParser parser = create(filename);    
	appointmentsflexibilized._ast.ASTDate ast;
    ast = parser.date_eof().ret;
    if (parser.hasErrors()) {
      setError(true);
      return Optional.<appointmentsflexibilized._ast.ASTDate> empty();
    }
    return Optional.ofNullable(ast);
  }
   ...
   * @throws IOException if something went wrong parsing the content of the reader
   * */
  public  Optional<appointmentsflexibilized._ast.ASTDate> parseDate(Reader reader) throws IOException {
 	AppointmentsFlexibilizedAntlrParser parser = create(reader);
	appointmentsflexibilized._ast.ASTDate ast;
    ast = parser.date_eof().ret;
    if (parser.hasErrors()) {
   ...
   * @throws IOException if something went wrong parsing the string
   * */
  public  Optional<appointmentsflexibilized._ast.ASTDate> parse_StringDate(String str) throws IOException {
   ...
   * @throws IOException if something went wrong parsing the file
   */
  public Optional<appointmentsflexibilized._ast.ASTTime> parseTime(String filename) throws IOException {   
    AppointmentsFlexibilizedAntlrParser parser = create(filename);    
	appointmentsflexibilized._ast.ASTTime ast;
    ast = parser.time_eof().ret;
    if (parser.hasErrors()) {
      setError(true);
      return Optional.<appointmentsflexibilized._ast.ASTTime> empty();
    }
    return Optional.ofNullable(ast);
  }
   ...
   * @throws IOException if something went wrong parsing the content of the reader
   * */
  public  Optional<appointmentsflexibilized._ast.ASTTime> parseTime(Reader reader) throws IOException {
 	AppointmentsFlexibilizedAntlrParser parser = create(reader);
	appointmentsflexibilized._ast.ASTTime ast;
    ast = parser.time_eof().ret;
    if (parser.hasErrors()) {
   ...
   * @throws IOException if something went wrong parsing the string
   * */
  public  Optional<appointmentsflexibilized._ast.ASTTime> parse_StringTime(String str) throws IOException {
   ...
   * @throws IOException if something went wrong parsing the file
   */
  public Optional<appointmentsflexibilized._ast.ASTBreak> parseR__break(String filename) throws IOException {   
    AppointmentsFlexibilizedAntlrParser parser = create(filename);    
	appointmentsflexibilized._ast.ASTBreak ast;
    ast = parser.r__break_eof().ret;
    if (parser.hasErrors()) {
      setError(true);
      return Optional.<appointmentsflexibilized._ast.ASTBreak> empty();
    }
    return Optional.ofNullable(ast);
  }
   ...
   * @throws IOException if something went wrong parsing the content of the reader
   * */
  public  Optional<appointmentsflexibilized._ast.ASTBreak> parseR__break(Reader reader) throws IOException {
 	AppointmentsFlexibilizedAntlrParser parser = create(reader);
	appointmentsflexibilized._ast.ASTBreak ast;
    ast = parser.r__break_eof().ret;
    if (parser.hasErrors()) {
   ...
   * @throws IOException if something went wrong parsing the string
   * */
  public  Optional<appointmentsflexibilized._ast.ASTBreak> parse_StringR__break(String str) throws IOException {
   ...
   * @throws IOException if something went wrong parsing the file
   */
  public Optional<appointmentsflexibilized._ast.ASTParticipants> parseParticipants(String filename) throws IOException {   
    AppointmentsFlexibilizedAntlrParser parser = create(filename);    
	appointmentsflexibilized._ast.ASTParticipants ast;
    ast = parser.participants_eof().ret;
    if (parser.hasErrors()) {
      setError(true);
      return Optional.<appointmentsflexibilized._ast.ASTParticipants> empty();
    }
    return Optional.ofNullable(ast);
  }
   ...
   * @throws IOException if something went wrong parsing the content of the reader
   * */
  public  Optional<appointmentsflexibilized._ast.ASTParticipants> parseParticipants(Reader reader) throws IOException {
 	AppointmentsFlexibilizedAntlrParser parser = create(reader);
	appointmentsflexibilized._ast.ASTParticipants ast;
    ast = parser.participants_eof().ret;
    if (parser.hasErrors()) {
   ...
   * @throws IOException if something went wrong parsing the string
   * */
  public  Optional<appointmentsflexibilized._ast.ASTParticipants> parse_StringParticipants(String str) throws IOException {
    return parseParticipants(new StringReader(str));
  }
   ...
   * @throws IOException if something went wrong parsing the file
   */
  public Optional<appointmentsflexibilized._ast.ASTFrequency> parseFrequency(String filename) throws IOException {   
    AppointmentsFlexibilizedAntlrParser parser = create(filename);    
	appointmentsflexibilized._ast.ASTFrequency ast;
    ast = parser.frequency_eof().ret;
    if (parser.hasErrors()) {
      setError(true);
      return Optional.<appointmentsflexibilized._ast.ASTFrequency> empty();
    }
    return Optional.ofNullable(ast);
  }
   ...
   * @throws IOException if something went wrong parsing the content of the reader
   * */
  public  Optional<appointmentsflexibilized._ast.ASTFrequency> parseFrequency(Reader reader) throws IOException {
 	AppointmentsFlexibilizedAntlrParser parser = create(reader);
	appointmentsflexibilized._ast.ASTFrequency ast;
    ast = parser.frequency_eof().ret;
    if (parser.hasErrors()) {
   ...
   * @throws IOException if something went wrong parsing the string
   * */
  public  Optional<appointmentsflexibilized._ast.ASTFrequency> parse_StringFrequency(String str) throws IOException {
    return parseFrequency(new StringReader(str));
  }
   ...
   * @throws IOException if something went wrong parsing the file
   */
  public Optional<appointmentsflexibilized._ast.ASTI> parseI(String filename) throws IOException {   
    AppointmentsFlexibilizedAntlrParser parser = create(filename);    
	appointmentsflexibilized._ast.ASTI ast;
    ast = parser.i_eof().ret;
    if (parser.hasErrors()) {
      setError(true);
      return Optional.<appointmentsflexibilized._ast.ASTI> empty();
    }
    return Optional.ofNullable(ast);
  }
   ...
   * @throws IOException if something went wrong parsing the content of the reader
   * */
  public  Optional<appointmentsflexibilized._ast.ASTI> parseI(Reader reader) throws IOException {
 	AppointmentsFlexibilizedAntlrParser parser = create(reader);
	appointmentsflexibilized._ast.ASTI ast;
    ast = parser.i_eof().ret;
    if (parser.hasErrors()) {
   ...
   * @throws IOException if something went wrong parsing the string
   * */
  public  Optional<appointmentsflexibilized._ast.ASTI> parse_StringI(String str) throws IOException {
