...
import de.monticore.ast.ASTCNode;
 ...
 public  class CalendarsScope  implements calendars._symboltable.ICalendarsScope {
 ...
 public  CalendarsScope()  {
    super();
    this.name = Optional.empty();
}

    /* generated by template core.Constructor*/
 public  CalendarsScope(boolean shadowing)  {
    this.shadowing = shadowing;
    this.name = Optional.empty();
}

    /* generated by template core.Constructor*/
 public  CalendarsScope(calendars._symboltable.ICalendarsScope enclosingScope)  {
    this(enclosingScope, false);
}

    /* generated by template core.Constructor*/
 public  CalendarsScope(calendars._symboltable.ICalendarsScope enclosingScope,boolean shadowing)  {
...
Log.error("0xA7003x787 SpanningSymbol can't return a value. It is empty.");
...
Log.error("0xA7003x111 Name can't return a value. It is empty.");
// Normally this statement is not reachable
throw new IllegalStateException();
...
Log.error("0xA7003x578 AstNode can't return a value. It is empty.");
// Normally this statement is not reachable
throw new IllegalStateException();
...
if (subScope.getEnclosingScope() != null && subScope.getEnclosingScope() == this) {
    ...
    /* generated by template core.Method*/
 public  List<calendars._symboltable.ICalendarsScope> getSubScopes ()  {
      /* generated by template _symboltable.scope.GetSubScopes*/
  return com.google.common.collect.ImmutableList.copyOf(subScopes);
}

    /* generated by template core.Method*/
 public  void setSubScopes (List<calendars._symboltable.ICalendarsScope> subScopes)  {
 ...
 public  void accept (de.monticore.literals.mccommonliterals._visitor.MCCommonLiteralsScopeVisitor visitor)  {
  ...
  if (visitor instanceof calendars._visitor.CalendarsScopeVisitor) {
    accept((calendars._visitor.CalendarsScopeVisitor) visitor);
  } else {
    throw new UnsupportedOperationException("0xA7010x251 Scope node type CalendarsScope expected a visitor of type calendars._visitor.CalendarsScopeVisitor, but got de.monticore.literals.mccommonliterals._visitor.MCCommonLiteralsScopeVisitor.");
  }
}
 ...
 public  void accept (de.monticore.mcbasics._visitor.MCBasicsScopeVisitor visitor)  {
  ...
  if (visitor instanceof calendars._visitor.CalendarsScopeVisitor) {
    ...
    throw new UnsupportedOperationException("0xA7010x988 Scope node type CalendarsScope expected a visitor of type calendars._visitor.CalendarsScopeVisitor, but got de.monticore.mcbasics._visitor.MCBasicsScopeVisitor.");
  }
}
 ...
 public  void accept (de.monticore.literals.mcliteralsbasis._visitor.MCLiteralsBasisScopeVisitor visitor)  {
  ...
  if (visitor instanceof calendars._visitor.CalendarsScopeVisitor) {
    ...
    throw new UnsupportedOperationException("0xA7010x099 Scope node type CalendarsScope expected a visitor of type calendars._visitor.CalendarsScopeVisitor, but got de.monticore.literals.mcliteralsbasis._visitor.MCLiteralsBasisScopeVisitor.");
  }
}

    /* generated by template core.Method*/
 public  void addSubScope (de.monticore.literals.mccommonliterals._symboltable.IMCCommonLiteralsScope subScope)  {
      this.addSubScope((calendars._symboltable.ICalendarsScope) subScope);
}

    /* generated by template core.Method*/
 public  void removeSubScope (de.monticore.literals.mccommonliterals._symboltable.IMCCommonLiteralsScope subScope)  {
      this.removeSubScope((calendars._symboltable.ICalendarsScope) subScope);
}
 ...
 public  void setEnclosingScope (de.monticore.literals.mccommonliterals._symboltable.IMCCommonLiteralsScope newEnclosingScope)  {
      this.setEnclosingScope((calendars._symboltable.ICalendarsScope) newEnclosingScope);
}
