...
import de.monticore.ast.ASTCNode;
 ...
 public  class CalendarsWithAppointmentsModelLoader  implements de.monticore.modelloader.IModelLoader<calendarswithappointments._ast.ASTCalendarsWithAppointments,calendarswithappointments._symboltable.ICalendarsWithAppointmentsGlobalScope> {

    /* generated by template core.Attribute*/
 protected  final  calendarswithappointments._symboltable.CalendarsWithAppointmentsLanguage modelingLanguage ;
 ...
 public  CalendarsWithAppointmentsModelLoader(calendarswithappointments._symboltable.CalendarsWithAppointmentsLanguage language)  {
...
return this.modelingLanguage;
    ...
    /* generated by template core.Method*/
 public  void createSymbolTableFromAST (calendarswithappointments._ast.ASTCalendarsWithAppointments ast,String modelName,calendarswithappointments._symboltable.ICalendarsWithAppointmentsGlobalScope enclosingScope)  {
      /* generated by template _symboltable.modelloader.CreateSymbolTableFromAST*/

  final calendarswithappointments._symboltable.CalendarsWithAppointmentsSymbolTableCreatorDelegator symbolTableCreator =
  ...
  if (symbolTableCreator != null) {
    ...
    CalendarsWithAppointmentsModelLoader.class.getSimpleName());
    final calendarswithappointments._symboltable.ICalendarsWithAppointmentsScope scope = symbolTableCreator.createFromAST(ast);

    if (!(scope instanceof calendarswithappointments._symboltable.CalendarsWithAppointmentsArtifactScope)) {
    ...
    Log.debug("Created symbol table for model \"" + modelName + "\".", CalendarsWithAppointmentsModelLoader.class.getSimpleName());
  }
  else {
    ...
    /* generated by template core.Method*/
 public  List<calendarswithappointments._ast.ASTCalendarsWithAppointments> loadModelsIntoScope (String qualifiedModelName,de.monticore.io.paths.ModelPath modelPath,calendarswithappointments._symboltable.ICalendarsWithAppointmentsGlobalScope enclosingScope)  {
  ...
  if (!loadSymbolsIntoScope(qualifiedModelName, modelPath, enclosingScope)) {
    final List<calendarswithappointments._ast.ASTCalendarsWithAppointments> asts = loadModels(qualifiedModelName, modelPath);
    for (calendarswithappointments._ast.ASTCalendarsWithAppointments ast : asts) {
  ...
  return new ArrayList<>();
    ...
    /* generated by template core.Method*/
 public  List<calendarswithappointments._ast.ASTCalendarsWithAppointments> loadModels (String qualifiedModelName,de.monticore.io.paths.ModelPath modelPath)  {
  ...
  final List<calendarswithappointments._ast.ASTCalendarsWithAppointments> foundModels = new ArrayList<>();
  ...
  if (resolvedCoordinate.hasLocation()) {
    final calendarswithappointments._ast.ASTCalendarsWithAppointments ast = astProvider.getRootNode(resolvedCoordinate);
  ...
  return foundModels;
    ...
    /* generated by template core.Method*/
 public  boolean loadSymbolsIntoScope (String qualifiedModelName,de.monticore.io.paths.ModelPath modelPath,calendarswithappointments._symboltable.ICalendarsWithAppointmentsGlobalScope enclosingScope)  {
  ...
  if (resolvedCoordinate.hasLocation()) {
    calendarswithappointments._symboltable.ICalendarsWithAppointmentsScope deser  = new calendarswithappointments._symboltable.serialization.CalendarsWithAppointmentsScopeDeSer().load(resolvedCoordinate.getLocation(), enclosingScope);
