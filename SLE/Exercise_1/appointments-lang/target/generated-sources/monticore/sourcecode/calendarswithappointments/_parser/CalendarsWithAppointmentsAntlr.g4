...
grammar CalendarsWithAppointmentsAntlr;
@parser::header {
...
'`s calendar:'// End of 'ASTTerminal'
 ...
 // Start of 'ASTClassProd CalendarsWithAppointments'


calendarsWithAppointments_eof returns [calendarswithappointments._ast.ASTCalendarsWithAppointments ret = null] :
  tmp = calendarsWithAppointments {$ret = $tmp.ret;} EOF ;


  calendarsWithAppointments returns [calendarswithappointments._ast.ASTCalendarsWithAppointments ret = null]
@init{// ret is normally returned, a is used to be compatible with rule using the return construct
...
i_eof returns [calendarswithappointments._ast.ASTI ret = null] :
  tmp = i {$ret = $tmp.ret;} EOF ;


  i returns [calendarswithappointments._ast.ASTI ret = null]
@init{// ret is normally returned, a is used to be compatible with rule using the return construct
...
@after{_aNode.set_SourcePositionEnd(computeEndPosition(_input.LT(-1)));}
 ...
 : 
   ...
   tmp0=appointment{_aNode.setAppointment(_localctx.tmp0.ret);}  
