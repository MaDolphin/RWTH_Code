...
import de.monticore.ast.ASTCNode;
 ...
 public  class AppointmentsScope  implements appointments._symboltable.IAppointmentsScope {
 ...
 public  AppointmentsScope()  {
    super();
    this.name = Optional.empty();
}

    /* generated by template core.Constructor*/
 public  AppointmentsScope(boolean shadowing)  {
    this.shadowing = shadowing;
    this.name = Optional.empty();
}

    /* generated by template core.Constructor*/
 public  AppointmentsScope(appointments._symboltable.IAppointmentsScope enclosingScope)  {
    this(enclosingScope, false);
}

    /* generated by template core.Constructor*/
 public  AppointmentsScope(appointments._symboltable.IAppointmentsScope enclosingScope,boolean shadowing)  {
...
Log.error("0xA7003x071 SpanningSymbol can't return a value. It is empty.");
...
Log.error("0xA7003x628 Name can't return a value. It is empty.");
// Normally this statement is not reachable
throw new IllegalStateException();
...
Log.error("0xA7003x334 AstNode can't return a value. It is empty.");
// Normally this statement is not reachable
throw new IllegalStateException();
...
if (subScope.getEnclosingScope() != null && subScope.getEnclosingScope() == this) {
    ...
    /* generated by template core.Method*/
 public  List<appointments._symboltable.IAppointmentsScope> getSubScopes ()  {
      /* generated by template _symboltable.scope.GetSubScopes*/
  return com.google.common.collect.ImmutableList.copyOf(subScopes);
}

    /* generated by template core.Method*/
 public  void setSubScopes (List<appointments._symboltable.IAppointmentsScope> subScopes)  {
 ...
 public  void accept (de.monticore.literals.mccommonliterals._visitor.MCCommonLiteralsScopeVisitor visitor)  {
  ...
  if (visitor instanceof appointments._visitor.AppointmentsScopeVisitor) {
    accept((appointments._visitor.AppointmentsScopeVisitor) visitor);
  } else {
    throw new UnsupportedOperationException("0xA7010x646 Scope node type AppointmentsScope expected a visitor of type appointments._visitor.AppointmentsScopeVisitor, but got de.monticore.literals.mccommonliterals._visitor.MCCommonLiteralsScopeVisitor.");
  }
}
 ...
 public  void accept (de.monticore.mcbasics._visitor.MCBasicsScopeVisitor visitor)  {
  ...
  if (visitor instanceof appointments._visitor.AppointmentsScopeVisitor) {
    ...
    throw new UnsupportedOperationException("0xA7010x447 Scope node type AppointmentsScope expected a visitor of type appointments._visitor.AppointmentsScopeVisitor, but got de.monticore.mcbasics._visitor.MCBasicsScopeVisitor.");
  }
}
 ...
 public  void accept (de.monticore.literals.mcliteralsbasis._visitor.MCLiteralsBasisScopeVisitor visitor)  {
  ...
  if (visitor instanceof appointments._visitor.AppointmentsScopeVisitor) {
    ...
    throw new UnsupportedOperationException("0xA7010x386 Scope node type AppointmentsScope expected a visitor of type appointments._visitor.AppointmentsScopeVisitor, but got de.monticore.literals.mcliteralsbasis._visitor.MCLiteralsBasisScopeVisitor.");
  }
}

    /* generated by template core.Method*/
 public  void addSubScope (de.monticore.literals.mccommonliterals._symboltable.IMCCommonLiteralsScope subScope)  {
      this.addSubScope((appointments._symboltable.IAppointmentsScope) subScope);
}

    /* generated by template core.Method*/
 public  void removeSubScope (de.monticore.literals.mccommonliterals._symboltable.IMCCommonLiteralsScope subScope)  {
      this.removeSubScope((appointments._symboltable.IAppointmentsScope) subScope);
}
 ...
 public  void setEnclosingScope (de.monticore.literals.mccommonliterals._symboltable.IMCCommonLiteralsScope newEnclosingScope)  {
      this.setEnclosingScope((appointments._symboltable.IAppointmentsScope) newEnclosingScope);
}
