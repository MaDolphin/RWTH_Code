...
import de.monticore.ast.ASTCNode;
 ...
 public  class AutomataArtifactScope extends automata._symboltable.AutomataScope  implements de.monticore.symboltable.IArtifactScope {
 ...
 public  AutomataArtifactScope(String packageName,List<de.monticore.symboltable.ImportStatement> imports)  {
    this(Optional.empty(), packageName, imports);
}

    /* generated by template core.Constructor*/
 public  AutomataArtifactScope(Optional<automata._symboltable.IAutomataScope> enclosingScope,String packageName,List<de.monticore.symboltable.ImportStatement> imports)  {
...
this.imports = imports;
 ...
 public  boolean checkIfContinueAsSubScope (String symbolName)  {
  ...
  return false;
    ...
    /* generated by template core.Method*/
 public  java.nio.file.Path getFilePath (automata._symboltable.AutomataLanguage lang)  {
 ...
 public  List<automata._symboltable.AutomatonSymbol> continueAutomatonWithEnclosingScope (boolean foundSymbols,String name,de.monticore.symboltable.modifiers.AccessModifier modifier,java.util.function.Predicate<automata._symboltable.AutomatonSymbol> predicate)  {
  ...
  final List<automata._symboltable.AutomatonSymbol> result = new ArrayList<>();

if (checkIfContinueWithEnclosingScope(foundSymbols) && enclosingScope != null) {
if (!(enclosingScope instanceof automata._symboltable.IAutomataGlobalScope)) {
  ...
  final List<automata._symboltable.AutomatonSymbol> resolvedFromEnclosing = enclosingScope.resolveAutomatonMany(foundSymbols,
