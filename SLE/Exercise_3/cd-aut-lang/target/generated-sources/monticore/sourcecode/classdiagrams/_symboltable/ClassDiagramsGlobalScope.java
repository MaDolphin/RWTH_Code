...
import de.monticore.ast.ASTCNode;
 ...
 public  class ClassDiagramsGlobalScope extends classdiagrams._symboltable.ClassDiagramsScope  implements classdiagrams._symboltable.IClassDiagramsGlobalScope {
 ...
 protected  ClassDiagramsLanguage classDiagramsLanguage ;
    ...
    /* generated by template core.Attribute*/
 protected  final  Map<String,Set<ClassDiagramsModelLoader>> modelName2ModelLoaderCache  = new HashMap<>();
 ...
 protected  List<de.monticore.types.typesymbols._symboltable.ITypeSymbolResolvingDelegate> adaptedTypeSymbolResolvingDelegate  = new ArrayList<de.monticore.types.typesymbols._symboltable.ITypeSymbolResolvingDelegate>();
    ...
    /* generated by template core.Attribute*/
 protected  List<classdiagrams._symboltable.ICDDefinitionSymbolResolvingDelegate> adaptedCDDefinitionSymbolResolvingDelegate  = new ArrayList<classdiagrams._symboltable.ICDDefinitionSymbolResolvingDelegate>();


    /* generated by template core.Constructor*/
 public  ClassDiagramsGlobalScope(de.monticore.io.paths.ModelPath modelPath,ClassDiagramsLanguage language)  {
    this.modelPath = Log.errorIfNull(modelPath);
    this.classDiagramsLanguage = Log.errorIfNull(language);
}
...
return this.classDiagramsLanguage;
 ...
 public  String getName ()  {
      Log.error("0xA6101x452 Global scopes do not have names.");
    return null;
}
 ...
 public  void cache (String calculatedModelName)  {
  ...
  ClassDiagramsModelLoader modelLoader = this.getClassDiagramsLanguage().getModelLoader() ;
  if (modelName2ModelLoaderCache.containsKey(calculatedModelName)) {
    ...
    final Set<ClassDiagramsModelLoader> ml = new LinkedHashSet<>();
    ml.add(modelLoader);
    ...
    /* generated by template core.Method*/
 public  boolean continueWithModelLoader (String calculatedModelName,ClassDiagramsModelLoader modelLoader)  {
...
return this.adaptedCDDefinitionSymbolResolvingDelegate;
    ...
    /* generated by template core.Method*/
 public  void clearAdaptedCDDefinitionSymbolResolvingDelegate ()  {
      /* generated by template methods.MethodDelegate*/
...
this.getAdaptedCDDefinitionSymbolResolvingDelegateList().clear();
    ...
    /* generated by template core.Method*/
 public  boolean addAdaptedCDDefinitionSymbolResolvingDelegate (classdiagrams._symboltable.ICDDefinitionSymbolResolvingDelegate element)  {
      /* generated by template methods.MethodDelegate*/

return this.getAdaptedCDDefinitionSymbolResolvingDelegateList().add(element);

}

    /* generated by template core.Method*/
 public  boolean addAllAdaptedCDDefinitionSymbolResolvingDelegate (Collection<? extends classdiagrams._symboltable.ICDDefinitionSymbolResolvingDelegate> collection)  {
      /* generated by template methods.MethodDelegate*/

return this.getAdaptedCDDefinitionSymbolResolvingDelegateList().addAll(collection);

}

    /* generated by template core.Method*/
 public  boolean removeAdaptedCDDefinitionSymbolResolvingDelegate (Object element)  {
      /* generated by template methods.MethodDelegate*/

return this.getAdaptedCDDefinitionSymbolResolvingDelegateList().remove(element);

}

    /* generated by template core.Method*/
 public  boolean removeAllAdaptedCDDefinitionSymbolResolvingDelegate (Collection<?> collection)  {
      /* generated by template methods.MethodDelegate*/

return this.getAdaptedCDDefinitionSymbolResolvingDelegateList().removeAll(collection);

}

    /* generated by template core.Method*/
 public  boolean retainAllAdaptedCDDefinitionSymbolResolvingDelegate (Collection<?> collection)  {
      /* generated by template methods.MethodDelegate*/

return this.getAdaptedCDDefinitionSymbolResolvingDelegateList().retainAll(collection);

}

    /* generated by template core.Method*/
 public  boolean removeIfAdaptedCDDefinitionSymbolResolvingDelegate (Predicate<? super classdiagrams._symboltable.ICDDefinitionSymbolResolvingDelegate> filter)  {
      /* generated by template methods.MethodDelegate*/

return this.getAdaptedCDDefinitionSymbolResolvingDelegateList().removeIf(filter);

}

    /* generated by template core.Method*/
 public  void forEachAdaptedCDDefinitionSymbolResolvingDelegate (Consumer<? super classdiagrams._symboltable.ICDDefinitionSymbolResolvingDelegate> action)  {
      /* generated by template methods.MethodDelegate*/
...
this.getAdaptedCDDefinitionSymbolResolvingDelegateList().forEach(action);
    ...
    /* generated by template core.Method*/
 public  void addAdaptedCDDefinitionSymbolResolvingDelegate (int index,classdiagrams._symboltable.ICDDefinitionSymbolResolvingDelegate element)  {
      /* generated by template methods.MethodDelegate*/
...
this.getAdaptedCDDefinitionSymbolResolvingDelegateList().add(index, element);
    ...
    /* generated by template core.Method*/
 public  boolean addAllAdaptedCDDefinitionSymbolResolvingDelegate (int index,Collection<? extends classdiagrams._symboltable.ICDDefinitionSymbolResolvingDelegate> collection)  {
      /* generated by template methods.MethodDelegate*/

return this.getAdaptedCDDefinitionSymbolResolvingDelegateList().addAll(index, collection);

}

    /* generated by template core.Method*/
 public  classdiagrams._symboltable.ICDDefinitionSymbolResolvingDelegate removeAdaptedCDDefinitionSymbolResolvingDelegate (int index)  {
      /* generated by template methods.MethodDelegate*/

return this.getAdaptedCDDefinitionSymbolResolvingDelegateList().remove(index);

}

    /* generated by template core.Method*/
 public  classdiagrams._symboltable.ICDDefinitionSymbolResolvingDelegate setAdaptedCDDefinitionSymbolResolvingDelegate (int index,classdiagrams._symboltable.ICDDefinitionSymbolResolvingDelegate element)  {
      /* generated by template methods.MethodDelegate*/

return this.getAdaptedCDDefinitionSymbolResolvingDelegateList().set(index, element);

}

    /* generated by template core.Method*/
 public  void replaceAllAdaptedCDDefinitionSymbolResolvingDelegate (UnaryOperator<classdiagrams._symboltable.ICDDefinitionSymbolResolvingDelegate> operator)  {
      /* generated by template methods.MethodDelegate*/
...
this.getAdaptedCDDefinitionSymbolResolvingDelegateList().replaceAll(operator);
    ...
    /* generated by template core.Method*/
 public  void sortAdaptedCDDefinitionSymbolResolvingDelegate (Comparator<? super classdiagrams._symboltable.ICDDefinitionSymbolResolvingDelegate> comparator)  {
      /* generated by template methods.MethodDelegate*/
...
this.getAdaptedCDDefinitionSymbolResolvingDelegateList().sort(comparator);
    ...
    /* generated by template core.Method*/
 public  void setAdaptedCDDefinitionSymbolResolvingDelegateList (List<classdiagrams._symboltable.ICDDefinitionSymbolResolvingDelegate> adaptedCDDefinitionSymbolResolvingDelegate)  {
      /* generated by template methods.Set*/
...
this.methodSymbolsAlreadyResolved = methodSymbolsAlreadyResolved;
 ...
 public  classdiagrams._symboltable.IClassDiagramsScope getEnclosingScope ()  {
      Log.error("0xA6100x313 GlobalScope ClassDiagramsGlobalScope has no EnclosingScope, so you cannot call methodgetEnclosingScope.");
    return null;
}

    /* generated by template core.Method*/
 public  void setEnclosingScope (classdiagrams._symboltable.IClassDiagramsScope enclosingScope)  {
      Log.error("0xA6100x451 GlobalScope ClassDiagramsGlobalScope has no EnclosingScope, so you cannot call methodsetEnclosingScope.");
}
...
List<classdiagrams._symboltable.CDDefinitionSymbol> adaptedSymbols = new ArrayList<classdiagrams._symboltable.CDDefinitionSymbol>();
for (classdiagrams._symboltable.ICDDefinitionSymbolResolvingDelegate symDel : adaptedCDDefinitionSymbolResolvingDelegate) {
adaptedSymbols.addAll(symDel.resolveAdaptedCDDefinitionSymbol(foundSymbols, name, modifier, predicate));
}
return adaptedSymbols;
}
