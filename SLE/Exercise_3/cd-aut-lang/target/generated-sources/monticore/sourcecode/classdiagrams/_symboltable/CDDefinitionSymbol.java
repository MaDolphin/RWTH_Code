...
import de.monticore.ast.ASTCNode;
 ...
 public  class CDDefinitionSymbol  implements classdiagrams._symboltable.ICommonClassDiagramsSymbol,de.monticore.symboltable.IScopeSpanningSymbol {
...
Log.error("0xA7003x460 AstNode can't return a value. It is empty.");
...
return this.astNode.isPresent();
    ...
    /* generated by template core.Method*/
 public  void setAstNode (classdiagrams._ast.ASTCDDefinition astNode)  {
...
this.packageName = packageName;
 ...
 public  String getPackageName ()  {
  ...
  return packageName;
    ...
    /* generated by template core.Method*/
 public  void accept (classdiagrams._visitor.ClassDiagramsSymbolVisitor visitor)  {
      visitor.handle(this);
}
...
classdiagrams._symboltable.IClassDiagramsScope optCurrentScope = enclosingScope;
while (optCurrentScope != null) {
final classdiagrams._symboltable.IClassDiagramsScope currentScope = optCurrentScope;
    ...
    } else if (currentScope instanceof classdiagrams._symboltable.ClassDiagramsArtifactScope) {
      return ((classdiagrams._symboltable.ClassDiagramsArtifactScope) currentScope).getPackageName();
    }
optCurrentScope = currentScope.getEnclosingScope();
 ...
 protected  String determineFullName ()  {
  ...
  final classdiagrams._symboltable.IClassDiagramsScope currentScope = optCurrentScope;
      ...
      if (!(currentScope instanceof classdiagrams._symboltable.IClassDiagramsGlobalScope)) {
        if (currentScope instanceof classdiagrams._symboltable.ClassDiagramsArtifactScope) {
