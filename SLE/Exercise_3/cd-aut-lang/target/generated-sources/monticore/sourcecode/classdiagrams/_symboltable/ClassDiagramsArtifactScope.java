...
import de.monticore.ast.ASTCNode;
 ...
 public  class ClassDiagramsArtifactScope extends classdiagrams._symboltable.ClassDiagramsScope  implements de.monticore.symboltable.IArtifactScope {
 ...
 public  ClassDiagramsArtifactScope(String packageName,List<de.monticore.symboltable.ImportStatement> imports)  {
    this(Optional.empty(), packageName, imports);
}

    /* generated by template core.Constructor*/
 public  ClassDiagramsArtifactScope(Optional<classdiagrams._symboltable.IClassDiagramsScope> enclosingScope,String packageName,List<de.monticore.symboltable.ImportStatement> imports)  {
...
this.imports = imports;
 ...
 public  boolean checkIfContinueAsSubScope (String symbolName)  {
  ...
  return false;
    ...
    /* generated by template core.Method*/
 public  java.nio.file.Path getFilePath (classdiagrams._symboltable.ClassDiagramsLanguage lang)  {
 ...
 public  List<classdiagrams._symboltable.CDDefinitionSymbol> continueCDDefinitionWithEnclosingScope (boolean foundSymbols,String name,de.monticore.symboltable.modifiers.AccessModifier modifier,java.util.function.Predicate<classdiagrams._symboltable.CDDefinitionSymbol> predicate)  {
      /* generated by template _symboltable.artifactscope.ContinueWithEnclosingScope*/

  final List<classdiagrams._symboltable.CDDefinitionSymbol> result = new ArrayList<>();

if (checkIfContinueWithEnclosingScope(foundSymbols) && enclosingScope != null) {
if (!(enclosingScope instanceof classdiagrams._symboltable.IClassDiagramsGlobalScope)) {
  ...
  final List<classdiagrams._symboltable.CDDefinitionSymbol> resolvedFromEnclosing = enclosingScope.resolveCDDefinitionMany(foundSymbols,
  ...
  return result;
    ...
    /* generated by template core.Method*/
 public  List<de.monticore.types.typesymbols._symboltable.TypeSymbol> continueTypeWithEnclosingScope (boolean foundSymbols,String name,de.monticore.symboltable.modifiers.AccessModifier modifier,java.util.function.Predicate<de.monticore.types.typesymbols._symboltable.TypeSymbol> predicate)  {
      /* generated by template _symboltable.artifactscope.ContinueWithEnclosingScope*/

  final List<de.monticore.types.typesymbols._symboltable.TypeSymbol> result = new ArrayList<>();
...
if (!(enclosingScope instanceof classdiagrams._symboltable.IClassDiagramsGlobalScope)) {
    ...
    for (final String potentialQualifiedName : potentialQualifiedNames) {
  final List<de.monticore.types.typesymbols._symboltable.TypeSymbol> resolvedFromEnclosing = enclosingScope.resolveTypeMany(foundSymbols,
  potentialQualifiedName, modifier, predicate);
      foundSymbols = foundSymbols | resolvedFromEnclosing.size() > 0;
      result.addAll(resolvedFromEnclosing);
    }
  ...
  return result;
    ...
    /* generated by template core.Method*/
 public  List<de.monticore.types.typesymbols._symboltable.TypeVarSymbol> continueTypeVarWithEnclosingScope (boolean foundSymbols,String name,de.monticore.symboltable.modifiers.AccessModifier modifier,java.util.function.Predicate<de.monticore.types.typesymbols._symboltable.TypeVarSymbol> predicate)  {
      /* generated by template _symboltable.artifactscope.ContinueWithEnclosingScope*/

  final List<de.monticore.types.typesymbols._symboltable.TypeVarSymbol> result = new ArrayList<>();
...
if (!(enclosingScope instanceof classdiagrams._symboltable.IClassDiagramsGlobalScope)) {
    ...
    for (final String potentialQualifiedName : potentialQualifiedNames) {
  final List<de.monticore.types.typesymbols._symboltable.TypeVarSymbol> resolvedFromEnclosing = enclosingScope.resolveTypeVarMany(foundSymbols,
  potentialQualifiedName, modifier, predicate);
      foundSymbols = foundSymbols | resolvedFromEnclosing.size() > 0;
      result.addAll(resolvedFromEnclosing);
    }
  ...
  return result;
    ...
    /* generated by template core.Method*/
 public  List<de.monticore.types.typesymbols._symboltable.FieldSymbol> continueFieldWithEnclosingScope (boolean foundSymbols,String name,de.monticore.symboltable.modifiers.AccessModifier modifier,java.util.function.Predicate<de.monticore.types.typesymbols._symboltable.FieldSymbol> predicate)  {
      /* generated by template _symboltable.artifactscope.ContinueWithEnclosingScope*/

  final List<de.monticore.types.typesymbols._symboltable.FieldSymbol> result = new ArrayList<>();
...
if (!(enclosingScope instanceof classdiagrams._symboltable.IClassDiagramsGlobalScope)) {
    ...
    for (final String potentialQualifiedName : potentialQualifiedNames) {
  final List<de.monticore.types.typesymbols._symboltable.FieldSymbol> resolvedFromEnclosing = enclosingScope.resolveFieldMany(foundSymbols,
  potentialQualifiedName, modifier, predicate);
      foundSymbols = foundSymbols | resolvedFromEnclosing.size() > 0;
      result.addAll(resolvedFromEnclosing);
    }
  ...
  return result;
    ...
    /* generated by template core.Method*/
 public  List<de.monticore.types.typesymbols._symboltable.MethodSymbol> continueMethodWithEnclosingScope (boolean foundSymbols,String name,de.monticore.symboltable.modifiers.AccessModifier modifier,java.util.function.Predicate<de.monticore.types.typesymbols._symboltable.MethodSymbol> predicate)  {
      /* generated by template _symboltable.artifactscope.ContinueWithEnclosingScope*/

  final List<de.monticore.types.typesymbols._symboltable.MethodSymbol> result = new ArrayList<>();
...
if (!(enclosingScope instanceof classdiagrams._symboltable.IClassDiagramsGlobalScope)) {
    ...
    for (final String potentialQualifiedName : potentialQualifiedNames) {
  final List<de.monticore.types.typesymbols._symboltable.MethodSymbol> resolvedFromEnclosing = enclosingScope.resolveMethodMany(foundSymbols,
  potentialQualifiedName, modifier, predicate);
      foundSymbols = foundSymbols | resolvedFromEnclosing.size() > 0;
      result.addAll(resolvedFromEnclosing);
    }
