...
if (!(enclosingScope instanceof automata._symboltable.IAutomataGlobalScope)) {
 ...
 public  List<automata._symboltable.StateSymbol> continueStateWithEnclosingScope (boolean foundSymbols,String name,de.monticore.symboltable.modifiers.AccessModifier modifier,java.util.function.Predicate<automata._symboltable.StateSymbol> predicate)  {
  ...
  final List<automata._symboltable.StateSymbol> result = new ArrayList<>();
...
if (!(enclosingScope instanceof automata._symboltable.IAutomataGlobalScope)) {
    ...
    for (final String potentialQualifiedName : potentialQualifiedNames) {
  final List<automata._symboltable.StateSymbol> resolvedFromEnclosing = enclosingScope.resolveStateMany(foundSymbols,
  potentialQualifiedName, modifier, predicate);
      foundSymbols = foundSymbols | resolvedFromEnclosing.size() > 0;
      result.addAll(resolvedFromEnclosing);
    }
