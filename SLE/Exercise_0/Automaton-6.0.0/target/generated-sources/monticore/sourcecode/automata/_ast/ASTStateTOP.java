...
import de.monticore.ast.ASTCNode;
 ...
 abstract  public  class ASTStateTOP extends ASTCNode  implements automata._ast.ASTAutomataNode {
 ...
 protected  boolean r__final ;
    ...
    /* generated by template core.Attribute*/
 protected  Optional<automata._symboltable.StateSymbol> symbol = Optional.empty();
...
this.r__final = r__final;
 ...
 public  void accept (automata._visitor.AutomataVisitor visitor)  {
    ...
    // We allow a down cast here, because the subclass ASTState must exist
    ...
    if (this instanceof ASTState) {
      visitor.handle((ASTState) this);
    } else {
      throw new UnsupportedOperationException("0xA7010x038 Only handwritten class ASTState is supported for the visitor");
    }
 ...
 public  Collection<de.monticore.ast.ASTNode> get_Children ()  {
    ...
    /* generated by template core.Method*/
 public  automata._symboltable.StateSymbol getSymbol ()  {
      /* generated by template methods.opt.Get*/

if (isPresentSymbol()) {
return this.symbol.get();
}
Log.error("0xA7003x828 Symbol can't return a value. It is empty.");
...
return this.symbol.isPresent();
    ...
    /* generated by template core.Method*/
 public  void setSymbol (automata._symboltable.StateSymbol symbol)  {
...
this.enclosingScope = enclosingScope;
 ...
 public  void setEnclosingScope (de.monticore.mcbasics._symboltable.IMCBasicsScope enclosingScope)  {
  ...
  if (enclosingScope instanceof automata._symboltable.IAutomataScope){
    ...
    de.se_rwth.commons.logging.Log.error("0xA7005x766The EnclosingScope form type de.monticore.mcbasics._symboltable.IMCBasicsScope could not be casted to the type automata._symboltable.IAutomataScope. Please call the Method setEnclosingScope with a parameter form type automata._symboltable.IAutomataScope");
  }
}
