...
bnet.CPD{P} = tabular_CPD(bnet, P, 'CPT', [1/2 1/2]);
bnet.CPD{SE} = tabular_CPD(bnet, SE, 'CPT', [0.89 1/3 0.89 0.15 0.1 1/3 0.1 0.15 0.01 1/3 0.01 0.7]);
bnet.CPD{SH} = tabular_CPD(bnet, SH, 'CPT', [0.89 0.05 0.89 1/3 0.1 0.15 0.1 1/3 0.01 0.8 0.01 1/3]);
...
% Report
fprintf('If E=T, SE = high, SH = mod and p(P=C) = 0\n');
